package javacore.orientacaoobjetos.ClassesUtilitarias.regex.test;
...
public class PatternMatcherTest05 {
    public static void main(String[] args) {
        ...
        // $
        // â (somente o chapeuzinho) em um [] pode ser usado no começo como negação, ex: [^abc] (nao encontrar abc ou algo assim) (parecido com o !)

        String regex = "([a-zA-Z\\d\\._-])+@([a-zA-Z])+\\.([a-zA-Z])+";
        String text = "JoaoPessoa@gmail.com.br, !@#JpAth@gmail.com, jfonsca@mail.br, teste@hotmail.com";
        System.out.println("Email Valido: ");
        System.out.println("!@#JpAth@gmail.com".matches(regex));
        System.out.println(Arrays.toString(text.split(",")));
        System.out.println(text.split(regex)[2].trim());
