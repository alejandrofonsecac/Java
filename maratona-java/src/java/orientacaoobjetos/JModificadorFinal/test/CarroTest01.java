package java.orientacaoobjetos.JModificadorFinal.test;

import java.orientacaoobjetos.JModificadorFinal.dominio.Carro;
import java.orientacaoobjetos.JModificadorFinal.dominio.Comprador;
import java.orientacaoobjetos.JModificadorFinal.dominio.Ferrari;
