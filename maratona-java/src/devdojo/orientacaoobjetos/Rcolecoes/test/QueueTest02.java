...
public class QueueTest02 {
    public static void main(String[] args) {
        Queue<Manga> mangas = new PriorityQueue<>(new MangaPrecoComparator().reversed());//Reverseed para inverter a ordem, antes era do menor para o maior agora e o maior para o menor
